...
class ProgressRepository {
  ...
  Future<Database> _initDb() async {
    ...
    return openDatabase(
      ...
      onCreate: (db, version) async {
        ...
        ''');
        developer.log('[ProgressRepository] question_results table created');
      },
  ...
  Future<void> saveResult(QuestionResult result, String scenarioId) async {
    try {
      ...
      developer.log(
          '[ProgressRepository] Saved: ${result.questionId} correct=${result.isCorrect}');
    } catch (e) {
      developer.log('[ProgressRepository] Error saving result: $e');
    }
  }
  ...
  Future<int> getTotalScore() async {
    ...
    final result = await database
        .rawQuery('SELECT SUM(score) as total FROM question_results');
